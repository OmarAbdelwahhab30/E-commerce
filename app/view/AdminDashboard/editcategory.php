...
?>
    ...
    <div class="container ">
        ...
        <div class="w-50 mx-auto ">
            ...
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLabel">Update A Category</h5>
            </div>
            ...
            <div class="modal-body">
                ...
                ?>
                <form method="post" action="<?=URLROOT?>AdminCategoryController/UpdateCategoryView/<?=$data->categid?>">

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">@</span>
                        <input type="text" class="form-control" name="categname" value="<?=$data->categname?>"  placeholder="name of the category" aria-label="" aria-describedby="basic-addon1" required>
                    </div>

                    <div class="input-group mb-3">
                        <textarea type="text" class="form-control" name="categdesc"  placeholder="Describe the category" aria-label="" aria-describedby="basic-addon2" ><?=$data->description?></textarea>
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="border rounded p-lg-3 mb-lg-3">
                            ...
                            <div class="form-check">
                                No <input class="form-check-input" value="no" type="radio" name="visibility" id="flexRadioDefault2">
                        ...
                        <div class="border rounded p-lg-3 mb-lg-3">
                            ...
                            <div class="form-check">
                                No <input class="form-check-input" value="no" type="radio" name="comments" id="flexRadioDefault4" >
                        ...
                        <div class="border rounded p-lg-3 mb-lg-3">
                            ...
                            <div class="form-check">
                                No <input class="form-check-input" value="no" type="radio" name="ads" id="flexRadioDefault6" >
